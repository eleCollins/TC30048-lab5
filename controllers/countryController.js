...
exports.getCountryById = async (req, res) => {
    try {
        ...
        console.error('Error al obtener el país:'
            , error);
...
exports.updateCountry = async (req, res) => {
    ...
    try {
        ...
        const [existingCountry] = await pool.query('SELECT * FROM country WHERE id = ?'
            , [countryId]);
...
exports.deleteCountry = async (req, res) => {
    ...
    try {
        ...
        // Eliminar el país
        await pool.query('DELETE FROM country WHERE id = ?'
            , [countryId]);
